...
public class HostManager : MonoBehaviour
{
    ...
    [SerializeField] private string gameplaySceneName = "Scene_World_01";
    [SerializeField] private string characterSelectSceneName = "Scene_Character_Selecting_01";
    ...
    private void Awake()
    {
        ...
        playerInputManager = playerInputPrefab.GetComponent<PlayerInputManager>();
    }
    ...
    public async void StartHost()
    {
        ...
        try
        {
            ...
            Lobby lobby = await Lobbies.Instance.CreateLobbyAsync("My Lobby", maxConnections, createLobbyOption);
            lobbyId = lobby.Id;
